    ...
    <div class="container-fluid">
      ...
      <div class="row content">
        ...
        <div class="col-sm-8 text-center" style="border: 1px solid #e9e9e9; margin-top: 20px;"><br>
          <div class="col-sm-4">
            <div class="thumbnail">
              <a href="cli_registrar_pedido.php"><img src="../imagens/pedreiro.jpeg" class="img-responsive" style="width:100%" alt="Image"></a>
              <p><b>Pedreiro</b></p>
            </div>
          </div>
          <div class="col-sm-4"> 
            <div class="thumbnail">
              <a href="cli_registrar_pedido.php"><img src="../imagens/eletricista.jpg" class="img-responsive" style="width:100%" alt="Image"></a>
              <p><b>Eletricista</b></p>
            </div>    
          </div>
          <div class="col-sm-4"> 
            <div class="thumbnail">
              <a href="cli_registrar_pedido.php"><img src="../imagens/encanador.jpg" class="img-responsive" style="width:100%" alt="Image"></a>
              <p><b>Encanador</b></p>
            </div>    
          </div>    
          </div>

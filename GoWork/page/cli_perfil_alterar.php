...
<html lang="en">
  ...
  <div class="container-fluid">
    <div class="row content">
          ...
          <form action="../function/cliente.php" method="post">
            <div class="form-group">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" name="nome" class="form-control" placeholder="Primeiro Nome" value="<?php echo $result['nome_cli'] ?>" required>
              </div>
              <div class="form-group col-md-6">
                <label for="inputPassword4">Sobrenome</label>
                <input type="text" name="sobren" class="form-control" placeholder="Segundo Nome" value="<?php echo $result['sobren_cli'] ?>" required>
              </div>
            </div>
      ...
      ?>
            <button type="submit" name="update" class="btn btn-primary" style="margin-left: 89%">Alterar</button>
          </form>
        </div>

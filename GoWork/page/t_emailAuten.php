...
<html>
	...
	<body id="login">
		<div class="formulario">
			<form action="../function/cliente.php" method="post"><br>
				<div class="email">
					...
					<a class="btn btn-link" href="../function/cliente.php?codaut=1" role="button">Enviar novamente</a>
				</div>
				<?php
				...
				if (isset($_SESSION['n_aut_cli'])) {
					header('Location: ../function/cliente.php?codaut=1');
					unset($_SESSION['n_aut_cli']);
				}
				?>
